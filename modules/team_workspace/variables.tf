variable "teams_tenant_id" {
  description = "(Required) The id of the teams tenant"
  type        = string
}
...
variable "channels_config" {
  ...
  description = <<EOT
    (Required) The list of teams channel configurations. Each configuration block supports fields documented below.
    ...
    teams_channel_id - (Required) The id of the Teams channel
    team_id - (Required) The id of the Teams team
